...
class home extends React.Component {
  ...
  handlePostButtonClick = () => {
    ...
    axios.post("http://192.168.0.121:1234/create", data)
      .then((response) => {
                              ...
                              <div>
                                <div Class="radio-button">
                                  <input
                                    ...
                                    id={`radio-on-${item.id}`}
                                    value="ON"
                                    onChange={() => this.handlePostButtonClick(item.id, "ON")}
                                    checked
                                  />
                                  <label htmlFor="`radio-on-${item.id}`">
                                    <b>On</b>
                                  </label>
                                </div>
                                <div Class="radio-button">
                                  <input
                                    ...
                                    // name="status-livingroom-light"
                                    name={`radio-${item.id}`}
                                    id={`radio-off-${item.id}`}
                                    value="OFF"
                                    onChange={() => this.handlePostButtonClick(item.id, "OFF")}
                                  />
                                  <label Class="status-off" htmlFor={`radio-off-${item.id}`}>
                                    <b>OFF</b>
                                  </label>
                                </div>
                              </div>
